...
ActiveRecord::Schema.define(version: 20180201023006) do
  ...
  create_table "data_product_metadata", force: :cascade do |t|
    t.string "title"
    t.text "description"
    ...
    t.index ["data_product_id"], name: "index_data_product_metadata_on_data_product_id"
  end
  ...
  add_foreign_key "data_product_metadata", "data_products"
